  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        InkWell(
        onTap: (){
          Navigator.pushNamed(context, DetailScreen.screename,arguments: item);
        ...
        InkWell(
          onTap: (){
            Navigator.pushNamed(context, DetailScreen.screename,arguments: item2);
                ...
                child: Column(
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: RatingBar.builder(
                        initialRating: item.reviews.stars,
                        minRating: 1,
                        direction: Axis.horizontal,
                        allowHalfRating: true,
                        itemCount: 5,
